...
public class WorkScreenElements
{
    public void getElementsByXPath(AndroidDriver<AndroidElement> driver)
    {
        driver.findElementByXPath("//android.widget.EditText[@text='Enter Your Employment Level Here']").sendKeys("hello");
        driver.findElementByXPath("//android.widget.EditText[@text='Enter Your Position Here']").sendKeys("hello");
        driver.findElementByXPath("//android.widget.EditText[@text='Enter Your Company Here']").sendKeys("hello");
        driver.findElementByXPath("//android.widget.EditText[@text='Enter Your Start Date Here']").sendKeys("hello");
